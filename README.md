...
2. `def query1_result()`: This function is used to find the most popular three articles of all time
3. `def query2_result()`: This function is used to find the most popular author of all time.
4. `def query3_result()`: This function is used to find the day in which http requests are leads to errors more than 1%.
